...
if __name__ == '__main__':
    ...
    os.system("python3 ../starter/tagger.py -d training1.txt training2.txt training3.txt -t test8.txt -o output.txt")
    ...
    with open("output.txt", "r") as output_file, \
         open("training8.txt", "r") as solution_file, \
    ...
    print("accuracy = {}".format(total_matches/len(output)))